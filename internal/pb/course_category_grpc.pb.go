...
type CategoryServiceClient interface {
	...
	ListCategoies(ctx context.Context, in *Blank, opts ...grpc.CallOption) (*CategoryList, error)
...
func (c *categoryServiceClient) ListCategoies(ctx context.Context, in *Blank, opts ...grpc.CallOption) (*CategoryList, error) {
	out := new(CategoryList)
	err := c.cc.Invoke(ctx, "/pb.CategoryService/ListCategoies", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type CategoryServiceServer interface {
	...
	ListCategoies(context.Context, *Blank) (*CategoryList, error)
...
func (UnimplementedCategoryServiceServer) ListCategoies(context.Context, *Blank) (*CategoryList, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ListCategoies not implemented")
}
...
func _CategoryService_ListCategoies_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/pb.CategoryService/ListCategoies",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CategoryServiceServer).ListCategoies(ctx, req.(*Blank))
	}
	return interceptor(ctx, in, info, handler)
}
