...
func (c *CategoryService) CreateCategory(ctx context.Context, r *pb.CreateCategoryRequest) (*pb.Category, error) {
...
func (c *CategoryService) ListCategoies(ctx context.Context, in *pb.Blank) (*pb.CategoryList, error) {
